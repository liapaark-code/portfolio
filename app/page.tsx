...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-[family-name:var(--font-clother)] bg-white pt-20">
      ...
      {/* ── FOOTER ── */}
      <footer className="relative z-30 border-t border-[#e5e5e7] bg-white px-8 py-14 mt-4">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col sm:grid sm:grid-cols-3 sm:items-start gap-10 mb-14">
            {/* Left: name */}
            <div>
              <p className="text-2xl font-bold text-[#1d1d1f]">lydia park</p>
            </div>
            {/* Center: nav */}
            <div className="flex flex-col gap-3">
              <button onClick={() => { setActiveTab("work");    scrollToTabs(); }} className="text-left text-sm text-[#8e8e93] hover:text-[#1D4ED8] transition-colors">(work)</button>
              <button onClick={() => { setActiveTab("gallery"); scrollToTabs(); }} className="text-left text-sm text-[#8e8e93] hover:text-[#1D4ED8] transition-colors">(gallery)</button>
              <button onClick={() => { setActiveTab("about");   scrollToTabs(); }} className="text-left text-sm text-[#8e8e93] hover:text-[#1D4ED8] transition-colors">(about)</button>
            </div>
            {/* Right: tagline, email, icons */}
            <div>
              <p className="text-sm text-[#8e8e93] mb-1">Let&apos;s work together!</p>
              <a href="mailto:liapaark@gmail.com" className="text-sm font-bold text-[#1d1d1f] hover:text-[#1D4ED8] transition-colors block mb-4">liapaark@gmail.com</a>
              <div className="flex gap-4">
                <a href="https://linkedin.com" className="text-[#c0c0c8] hover:text-[#1D4ED8] transition-colors" aria-label="LinkedIn">
