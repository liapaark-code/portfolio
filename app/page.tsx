    ...
    <div className="min-h-screen font-[family-name:var(--font-clother)] bg-white pt-20">
      ...
      <footer className="relative z-30 px-10 py-12 border-t border-[#e5e5e7] bg-white">
        <div className="max-w-5xl mx-auto flex items-start justify-between">
          ...
          <div className="flex gap-10 text-sm text-[#8e8e93]">
            <button onClick={() => { setActiveTab("work");    scrollToTabs(); }} className="hover:text-[#1D4ED8] transition-colors">(work)</button>
          ...
          <div className="text-right">
            ...
            <p className="text-xs text-[#8e8e93]">@Lydia Park 2026</p>
          </div>
        </div>
      </footer>
